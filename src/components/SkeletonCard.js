    ...
    <div className="flex flex-col w-full min-h-screen bg-transparent">
      <header className="flex items-center justify-between px-6 py-3 border-b bg-transparent">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2">
            <Skeleton className="h-5 w-5 rounded-full" />
            <div className="w-20 h-2.5 rounded-full bg-transparent">
              <div className="h-full w-3/4 rounded-full bg-transparent" />
            </div>
          </div>
        </div>
      </header>
      ...
      <footer className="flex items-center justify-center gap-4 px-4 py-3 bg-transparent rounded-t-xl">
